...
function listSongs(req, res)
{
  ...
  con.connect(function(err) 
  {
    ...
    {
      con.query("SELECT * FROM SONG WHERE (USER_ID) = (?) ORDER BY SONG_NAME", [req.session.userid], function (err, result, fields) 
      {
        if (err) 
          writeResult(req, res, {'error' : err});
        else
...
function addSong(req, res)
{
  ...
  else
  {
    ...
    con.connect(function(err) 
    {
      ...
      {
        con.query('INSERT INTO SONG (SONG_NAME, USER_ID) VALUES (?,?)', [req.query.song, req.session.userid], function (err, result, fields) 
        {
          if (err) 
            writeResult(req, res, {'error' : err});
          else
...
function removeSong(req, res)
{
  ...
  else
  {
    ...
    con.connect(function(err) 
    {
      ...
      {
        con.query('DELETE FROM SONG WHERE (SONG_NAME, USER_ID) = (?, ?)', [req.query.song, req.session.userid], function (err, result, fields) 
        {
          if (err) 
            writeResult(req, res, {'error' : err});
          else
...
function clearSongs(req, res)
{
  ...
  con.connect(function(err) 
  {
    ...
    {
      con.query('DELETE FROM SONG WHERE USER_ID = ?',[req.session.userid], function (err, result, fields) 
      {
        if (err) 
          writeResult(req, res, {'error' : err});
        else
